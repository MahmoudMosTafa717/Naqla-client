                            ...
                            return (
                              ...
                              >
                                ...
                                <div className="flex-1 min-w-0">
                                  <p
                                    className={`text-sm tracking-tight ${!notif.read ? "font-bold text-gray-900" : "font-semibold text-gray-600"}`}
                                  >
                                    {notif.title}
                                  </p>
                                  <p
                                    className={`text-xs mt-0.5 line-clamp-2 ${!notif.read ? "text-gray-700 font-medium" : "text-gray-500"}`}
                                  >
                                    {notif.message}
                                  </p>
